...
const copy: Record<Locale, Copy> = {
  en: {
    back: 'Back to home',
    aboutTitle: 'About Yasaflow',
    aboutIntro: 'A calm digital home for organizations, communities and members.',
    aboutBody: [
      'Yasaflow helps associations, clubs, faith communities, volunteer organizations and other member-based groups manage members, activities, communication, donations and administration in one place.',
      'The platform is developed with clarity, accessibility and responsible access at its core. We improve Yasaflow continuously based on feedback from the organizations that use it.',
    ],
    contactTitle: 'Contact Yasaflow',
    contactIntro: 'Questions about the product, subscriptions, billing or technical support are welcome.',
    response: 'We normally reply within one business day.',
    feedbackTitle: 'Help us improve Yasaflow',
    feedbackIntro: 'Have an idea, found a problem or need a feature? We read every submission.',
    name: 'Name', email: 'Email', category: 'Category', message: 'Describe your feedback',
    idea: 'Idea', bug: 'Bug', feature: 'Feature request', other: 'Other',
  ...
  nb: {
    ...
    aboutTitle: 'Om Yasaflow',
    aboutIntro: 'Et oversiktlig digitalt hjem for organisasjoner, fellesskap og medlemmer.',
    aboutBody: [
      'Yasaflow hjelper foreninger, klubber, tros- og livssynssamfunn, frivillige organisasjoner og andre medlemsbaserte fellesskap med å håndtere medlemmer, aktiviteter, kommunikasjon, donasjoner og administrasjon på ett sted.',
      'Plattformen utvikles med tydelighet, tilgjengelighet og ansvarlig tilgang som grunnprinsipper. Vi forbedrer Yasaflow kontinuerlig basert på tilbakemeldinger fra organisasjonene som bruker løsningen.',
    ],
    contactTitle: 'Kontakt Yasaflow',
    contactIntro: 'Du er velkommen til å kontakte oss om produktet, abonnement, fakturering eller teknisk hjelp.',
    response: 'Vi svarer normalt innen én virkedag.',
    feedbackTitle: 'Hjelp oss å forbedre Yasaflow',
    feedbackIntro: 'Har du en idé, funnet en feil eller savner en funksjon? Vi leser alle innspill.',
    name: 'Navn', email: 'E-post', category: 'Kategori', message: 'Beskriv tilbakemeldingen',
    idea: 'Idé', bug: 'Feil', feature: 'Funksjonsønske', other: 'Annet',
  ...
  tr: {
    ...
    aboutTitle: 'Yasaflow hakkında',
    aboutIntro: 'Kurumlar, topluluklar ve üyeler için sade bir dijital merkez.',
    aboutBody: [
      'Yasaflow; derneklerin, kulüplerin, inanç topluluklarının, gönüllü kuruluşların ve diğer üye tabanlı toplulukların üyeleri, etkinlikleri, iletişimi, bağışları ve yönetimi tek yerde yürütmesine yardımcı olur.',
      'Platform; netlik, erişilebilirlik ve sorumlu erişim ilkeleriyle geliştirilir. Yasaflow’u kullanan kurumların geri bildirimleri doğrultusunda sürekli iyileştiriyoruz.',
    ],
    contactTitle: 'Yasaflow ile iletişim',
    contactIntro: 'Ürün, abonelik, faturalandırma veya teknik destek hakkında bize ulaşabilirsiniz.',
    response: 'Normalde bir iş günü içinde yanıt veririz.',
    feedbackTitle: 'Yasaflow’u geliştirmemize yardımcı olun',
    feedbackIntro: 'Bir fikriniz mi var, hata mı buldunuz veya yeni bir özelliğe mi ihtiyacınız var? Tüm iletileri okuyoruz.',
    name: 'Ad', email: 'E-posta', category: 'Kategori', message: 'Geri bildiriminizi açıklayın',
    idea: 'Fikir', bug: 'Hata', feature: 'Özellik talebi', other: 'Diğer',
