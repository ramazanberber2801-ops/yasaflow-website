...
type Copy = {
  ...
  servicesTitle: string; servicesBody: string;
...
const copy: Record<Locale, Copy> = {
  en: {
    ...
    servicesTitle: 'Services', servicesBody: 'Cloud-based software for organizations, including member management, activities, communication and administration.',
  ...
  nb: {
    ...
    servicesTitle: 'Tjenester', servicesBody: 'Skybasert programvare for organisasjoner, med medlemsadministrasjon, aktiviteter, kommunikasjon og drift samlet på ett sted.',
  ...
  tr: {
    ...
    servicesTitle: 'Hizmetler', servicesBody: 'Kurumlar için üye yönetimi, etkinlikler, iletişim ve idari süreçleri bir araya getiren bulut tabanlı yazılım.',
