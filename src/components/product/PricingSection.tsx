...
const copy = {
  en: { eyebrow: 'Pricing', title: 'Start with the core platform. Add only what you need.', intro: 'Try Yasaflow free for 7 days. After the trial, the core platform starts from NOK 349 per month. Optional add-on modules increase the monthly price, and the complete total is shown before purchase.', base: 'Core platform', monthly: 'NOK/month', included: 'Included in the base platform', addOns: 'Active add-on modules', addOnIntro: 'Select modules to calculate the monthly total.', total: 'Estimated monthly total after trial', start: 'Start 7-day free trial', storage: '2 GB storage', alerts: 'System notifications', selected: 'Selected', select: 'Add module', renewal: 'Renews automatically until cancelled. Cancel before the trial ends to avoid being charged.' },
  nb: { eyebrow: 'Priser', title: 'Start med grunnplattformen. Legg bare til det dere trenger.', intro: 'Prøv Yasaflow gratis i 7 dager. Etter prøveperioden koster grunnplattformen fra 349 kr per måned. Valgfrie tilleggsmoduler øker månedsprisen, og den totale abonnementsprisen vises før kjøpet bekreftes.', base: 'Grunnplattform', monthly: 'kr/mnd', included: 'Inkludert i grunnplattformen', addOns: 'Aktive tilleggsmoduler', addOnIntro: 'Velg moduler for å beregne månedsprisen.', total: 'Beregnet total per måned etter prøveperioden', start: 'Start 7 dagers gratis prøveperiode', storage: '2 GB lagring', alerts: 'Systemvarsler', selected: 'Valgt', select: 'Legg til modul', renewal: 'Abonnementet fornyes automatisk til det sies opp. Avslutt før prøveperioden utløper for å unngå belastning.' },
  tr: { eyebrow: 'Fiyatlandırma', title: 'Temel platformla başlayın. Yalnızca ihtiyacınız olan modülleri ekleyin.', intro: 'Yasaflow’u 7 gün ücretsiz deneyin. Deneme sonrasında temel platform aylık 349 NOK’dan başlar. Ek modüller aylık fiyatı artırır ve toplam abonelik fiyatı satın almadan önce gösterilir.', base: 'Temel platform', monthly: 'NOK/ay', included: 'Temel platforma dahil', addOns: 'Aktif ek modüller', addOnIntro: 'Aylık toplamı hesaplamak için modülleri seçin.', total: 'Deneme sonrası tahmini aylık toplam', start: '7 günlük ücretsiz denemeyi başlat', storage: '2 GB depolama', alerts: 'Sistem bildirimleri', selected: 'Seçildi', select: 'Modül ekle', renewal: 'Abonelik iptal edilene kadar otomatik yenilenir. Ücret alınmaması için deneme bitmeden iptal edin.' },
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-14 grid gap-6 lg:grid-cols-[1fr_1.15fr]">
        <article className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-[0_18px_55px_rgba(15,23,42,.07)] sm:p-9">
          ...
          <p className="mt-4 text-xs leading-5 text-slate-500">{t.renewal}</p>
        </article>
