...
const labels: Record<Locale, { privacy: string; terms: string; resources: Array<[string, string]> }> = {
  en: { privacy: 'Privacy', terms: 'Terms', resources: [['Resources', '/resources'], ['FAQ', '/faq'], ['Security', '/security'], ['Roadmap', '/roadmap'], ['Integrations', '/integrations']] },
  nb: { privacy: 'Personvern', terms: 'Vilkår', resources: [['Ressurser', '/resources'], ['FAQ', '/faq'], ['Sikkerhet', '/security'], ['Veikart', '/roadmap'], ['Integrasjoner', '/integrations']] },
  tr: { privacy: 'Gizlilik', terms: 'Koşullar', resources: [['Kaynaklar', '/resources'], ['SSS', '/faq'], ['Güvenlik', '/security'], ['Yol haritası', '/roadmap'], ['Entegrasyonlar', '/integrations']] },
};
