...
const text: Record<Locale, Text> = {
  en: {
    ...
    badge: 'One digital home for your organization', hero: 'Bring your community together.', accent: 'Run it with clarity.',
    intro: 'Yasaflow brings members, activities, communication, donations and administration together in one calm platform—so your organization can focus on the people it serves.',
  ...
  nb: {
    ...
    intro: 'Yasaflow samler medlemmer, aktiviteter, kommunikasjon, donasjoner og administrasjon i én oversiktlig plattform – slik at organisasjonen kan konsentrere seg om menneskene den er til for.',
  ...
  tr: {
    ...
    badge: 'Kurumunuz için tek dijital merkez', hero: 'Topluluğunuzu bir araya getirin.', accent: 'Her şeyi netlikle yönetin.',
    intro: 'Yasaflow; üyeleri, etkinlikleri, iletişimi, bağışları ve günlük yönetimi tek bir sade platformda buluşturur. Böylece kurumunuz asıl amacı olan topluluğuna odaklanır.',
    ...
    cta: 'Sıradaki adım', ctaTitle: 'Başlamaya hazır mısınız?', ctaBody: 'Kurumunuza netlik, güven ve uzun vadeli büyüme için tasarlanmış dijital bir merkez kazandırın.', footer: 'Kurumlar, topluluklar ve üyeler için modern bir dijital merkez.', privacy: 'Gizlilik', terms: 'Kullanım koşulları',
  },
};
...
export default function App() {
  ...
  return <div className="overflow-hidden bg-white text-slate-950">
    ...
    <footer className="border-t border-slate-200 px-5 py-12 sm:px-8"><div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-center lg:justify-between"><div><Logo /><p className="mt-3 max-w-sm text-sm text-slate-500">{t.footer}</p></div><div className="flex flex-wrap items-center gap-5 text-sm font-medium text-slate-600"><LanguageSelector /><a href="/privacy">{t.privacy}</a><a href="/terms">{t.terms}</a></div></div></footer>
  </div>;
}