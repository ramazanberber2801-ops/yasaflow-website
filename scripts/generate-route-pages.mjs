...
const routes = {
  about: { title: 'About Yasaflow — Cloud-based SaaS for organizations', description: 'Learn how Yasaflow helps organizations, associations and communities manage members, activities, communication and administration.' },
  contact: { title: 'Contact Yasaflow — Book a demo', description: 'Contact Yasaflow to discuss your organization, explore the SaaS platform or book a product demonstration.' },
  modules: { title: 'Yasaflow Module Library — Features for organizations', description: 'Explore Yasaflow modules for news, activities, members, administration, notifications and external donation links.' },
